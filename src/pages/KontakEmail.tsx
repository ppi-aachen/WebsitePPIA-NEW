          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" data-sb-field-path={`sections.${contactListIndex}`}>
            <div className="p-8 md:p-12">
              ...
              <div className="mt-12 bg-gray-50 p-6 rounded-xl text-center">
                <p className="body-text mb-2 font-medium" data-sb-field-path="officeName">{contactListSection?.officeName || "Sekretariat PPI Aachen"}</p>
                <p className="body-text text-sm mt-0 text-gray-600" data-sb-field-path="officeAddress">{contactListSection?.officeAddress || "An der Schanz 1, 52064 Aachen, Germany"}</p>
                <p className="body-text text-[#0161bf] font-medium mt-2" data-sb-field-path="whatsappNumber">{contactListSection?.whatsappNumber || "+49 15679 027862 (WA Only)"}</p>
              </div>
            </div>
          </section>
        </div>
