    ...
    <div data-sb-object-id="content/pages/press-kit.json">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        {headerSection && (
          ...
          >
            <div>
              <h2 className="heading-3 text-[#002F6C] mb-2" data-sb-field-path="title">{headerSection.title}</h2>
              <p className="text-gray-600" data-sb-field-path="subtitle">{headerSection.subtitle}</p>
            </div>
